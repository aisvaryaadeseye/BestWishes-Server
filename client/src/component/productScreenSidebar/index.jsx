...
const ProductScreenSidebar = ({ sideBarText }) => {
  ...
  return (
    <div className="product-screen-container">
      ...
      <div className="productScreenLeftContainer">
        <p className="clothing">{sideBarText}</p>
        ...
        <form>
          <div className="checkboxRow">
            ...
            />{" "}
            &nbsp; &nbsp;
            <label className="checkboxLabel" htmlFor="bagsId">
              Bags
            </label>
          </div>
          <div className="checkboxRow">
            ...
            />{" "}
            &nbsp; &nbsp;
            <label className="checkboxLabel" htmlFor="beadsId">
              Beads
            </label>
          </div>
          <div className="checkboxRow">
            ...
            />{" "}
            &nbsp; &nbsp;
            <label className="checkboxLabel" htmlFor="beltId">
              Belt
            </label>
          </div>
          <div className="checkboxRow">
            ...
            />{" "}
            &nbsp; &nbsp;
            <label className="checkboxLabel" htmlFor="capId">
              Cap
            </label>
          </div>
          <div className="checkboxRow">
            ...
            />{" "}
            &nbsp; &nbsp;
            <label className="checkboxLabel" htmlFor="handBagId">
              Hand Bags
            </label>
          </div>
          <div className="checkboxRow">
            ...
            />{" "}
            &nbsp; &nbsp;
            <label className="checkboxLabel" htmlFor="jeansId">
              Jeans
            </label>
          </div>
          <div className="checkboxRow">
            ...
            />{" "}
            &nbsp; &nbsp;
            <label className="checkboxLabel" htmlFor="jewelriesId">
              Jewelries
            </label>
          </div>
          <div className="checkboxRow">
            ...
            />{" "}
            &nbsp; &nbsp;
            <label className="checkboxLabel" htmlFor="pantsId">
              Pants
            </label>
          </div>
          <div className="checkboxRow">
            ...
            />{" "}
            &nbsp; &nbsp;
            <label className="checkboxLabel" htmlFor="shoesId">
              Shoes
            </label>
          </div>
          <div className="checkboxRow">
            ...
            />{" "}
            &nbsp; &nbsp;
            <label className="checkboxLabel" htmlFor="trouserId">
              Trousers
            </label>
          </div>
          <div className="checkboxRow">
            ...
            />{" "}
            &nbsp; &nbsp;
            <label className="checkboxLabel" htmlFor="tshirtsId">
              T-shirts
            </label>
          </div>
        </form>
      ...
      <div className="productScreenLeftBrands">
        ...
        <form>
          <div className="checkboxRow">
            ...
            />{" "}
            &nbsp; &nbsp;
            <label className="checkboxLabel" htmlFor="ourBrandId">
              Our Brands
            </label>
          </div>
          <div className="checkboxRow">
            ...
            />{" "}
            &nbsp; &nbsp;
            <label className="checkboxLabel" htmlFor="premiumBrandId">
              Premium Brands
            </label>
          </div>
          <div className="checkboxRow">
            ...
            />{" "}
            &nbsp; &nbsp;
            <label className="checkboxLabel" htmlFor="popularbrandId">
              Popular Brands
            </label>
          </div>
        </form>
