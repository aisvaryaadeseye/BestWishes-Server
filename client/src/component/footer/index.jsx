    ...
    <FooterContainer className='footerContainer'>
        ...
        <div className="footerContact">
          ...
          <div className="footerContactText">
            <i className="fas fa-phone linkIcon"></i> <p>+356 999 1234</p>
          </div>
          <div className="footerContactText">
            <i className="fa-solid fa-location-dot"></i><p>Lukiokatu 77, Tavastia Proper</p>
          </div>
          <div className="footerContactText">
            <i className="fa-solid fa-envelope"></i> <p>Bestwishes"gmail.com</p>
          </div>
        ...
        <div className="footerSocial">
          <p>Our Social</p>
            <span className='socialLink'><i className="fa-brands fa-linkedin socialIcon"></i>Linkedin</span>
            <span className='socialLink'><i className="fa-brands fa-facebook socialIcon"></i> Facebook</span>
            <span className='socialLink'> <i className="fa-brands fa-twitter-square socialIcon"></i>Twitter</span>
            <span className='socialLink'> <i className="fa-brands fa-instagram-square socialIcon"></i>Instagram</span>
