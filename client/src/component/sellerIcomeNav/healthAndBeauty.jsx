...
const items = [
  <SellerIncomeMobile categories="Home & Beauty" />,
  <SellerIncomeMobile categories="Home & Beauty" />,
  <SellerIncomeMobile categories="Home & Beauty" />,
];
const SellerHealthAndBeauty = () => {
  return (
    <>
      <div className="seller-all-income">
        ...
        <div className="seller-all-income-bottom">
          <SellerIncomeProductDetail categories="Home & Beauty" />
          <SellerIncomeProductDetail categories="Home & Beauty" />
          <SellerIncomeProductDetail categories="Home & Beauty" />
          <SellerIncomeProductDetail categories="Home & Beauty" />
          <SellerIncomeProductDetail categories="Home & Beauty" />
...
export default SellerHealthAndBeauty;
